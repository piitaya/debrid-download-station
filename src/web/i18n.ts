...
const fr = {
  ...
  'nas.otpHint':
    'Saisissez le code de l’application d’authentification du compte DSM. Il ne sera plus demandé.',
  'nas.insecureTls': 'Certificat auto-signé',
  ...
  'password.footer': '8 caractères minimum. Vos autres appareils seront déconnectés.',
  ...
  'status.waitingNas': 'En attente de Download Station',
  ...
  'error.wrong_password': 'Mot de passe actuel incorrect.',
  'error.weak_password': 'Le mot de passe doit contenir au moins 8 caractères.',
  ...
  'error.otp_setup_required':
    'La validation en deux étapes est obligatoire pour ce compte DSM. Activez-la d’abord dans DSM.',
  'error.no_permission': 'Ce compte DSM n’a pas accès à Download Station.',
  'error.file_station_denied': 'Ce compte DSM n’a pas accès à File Station.',
  'error.account_disabled': 'Ce compte DSM est désactivé.',
  'error.password_expired': 'Le mot de passe du compte DSM a expiré. Modifiez-le depuis DSM.',
  'error.ip_blocked': 'Adresse IP bloquée par le NAS après trop de tentatives.',
  'error.nas_not_configured': 'Download Station n’est pas encore configuré.',
  'error.nas_login_failed':
    'Download Station refuse la connexion. Vérifiez le compte DSM dans les réglages.',
  'error.nas_session_expired': 'La session DSM a expiré. Réessayez.',
  'error.nas_unreachable': 'NAS injoignable. Vérifiez son adresse.',
  'error.nas_certificate':
    'Certificat du NAS refusé. S’il est auto-signé, activez « Certificat auto-signé ».',
...
const en: Record<MessageKey, string> = {
  ...
  'nas.otpHint':
    'Enter the code from the DSM account’s authenticator app. It will not be asked again.',
  'nas.insecureTls': 'Self-signed certificate',
  ...
  'password.footer': 'At least 8 characters. Your other devices will be signed out.',
  ...
  'status.waitingNas': 'Waiting for Download Station',
  ...
  'error.weak_password': 'The password must be at least 8 characters long.',
  ...
  'error.otp_setup_required':
    '2-step verification is required for this DSM account. Set it up in DSM first.',
  'error.no_permission': 'This DSM account has no access to Download Station.',
  'error.file_station_denied': 'This DSM account has no access to File Station.',
  'error.account_disabled': 'This DSM account is disabled.',
  'error.password_expired': 'The DSM account’s password has expired. Change it from DSM.',
  'error.ip_blocked': 'IP address blocked by the NAS after too many attempts.',
  'error.nas_not_configured': 'Download Station is not set up yet.',
  'error.nas_login_failed':
    'Download Station refuses the connection. Check the DSM account in Settings.',
  'error.nas_session_expired': 'The DSM session expired. Try again.',
  'error.nas_unreachable': 'Cannot reach the NAS. Check its address.',
  'error.nas_certificate':
    'The NAS certificate was rejected. If it is self-signed, turn on “Self-signed certificate”.',
